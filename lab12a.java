...
public class lab12a {
		...
		public static void saveList(Scanner sIn, ArrayList<String> shoppingList, String fileName) {
			...
			try {
				...
				System.out.printf("Error: File %s not found.", fileName1);
			}
			
			
			
			answer = getValidYN("Are you sure you wish to overwrite the 'Shopping List.txt' file with your current list? (Y/N)", "\"Error: Please enter Y or N.\"");
				
				
				if(answer.equalsIgnoreCase("Y")) {
					System.out.printf("Shopping List saved to file: %s", fileName1);
